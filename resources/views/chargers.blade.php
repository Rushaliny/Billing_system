                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-primary editBtn" data-toggle="modal"
                                        data-target="#editModal" data-id="{{ $charger->id }}"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="add_applicable_to" name="applicable_to" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="add_amount" name="amount" required>
                            </div>
                        </div>
