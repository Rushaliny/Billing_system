            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-sm-2 col-form-label">ZB Account No</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="account_number" readonly
                                value="{{ auth()->user()->account_number ?? '' }}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Payee Account Number</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="payee_account_number" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4"><input type="number" class="form-control" id="base_amount" name="base_amount"
                                required></div>
                    </div>
